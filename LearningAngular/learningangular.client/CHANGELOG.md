...
- Create Angular project with ng: `ng new learningangular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`learningangular.client.esproj`).
